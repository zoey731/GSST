...
class Blip2Base(BaseModel):
    @classmethod
    def init_tokenizer(cls, bert_name='/home/zhoujie/pretrained_models/scibert_scivocab_uncased'):
        print(f'tokenizer load {bert_name}')
    ...
    @classmethod
    def init_Qformer(cls, bert_name, num_query_token, graph_width, cross_attention_freq=2):
        # assert 'scibert' in bert_name
        print("bert load {}".format(bert_name.split("/")[-1]))
    ...
    def init_graph_encoder(
        ...
        ckpt = torch.load('gin_pretrained/graphcl_80.pth', weights_only=False, map_location=torch.device('cpu'))
